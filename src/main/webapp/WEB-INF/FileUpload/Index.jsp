...
<head>
    ...
    <script src="${pageContext.request.contextPath}/assets/jquery-2.1.4.min.js"></script>
    <link href="${pageContext.request.contextPath}/assets/webuploader.css" rel="stylesheet"/>
    <script src="${pageContext.request.contextPath}/assets/webuploader.nolog.min.js"></script>
